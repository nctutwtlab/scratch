...
def _notify_callbackx( sender, data):
    global acc_list,gyr_list,cur_count,stored_count,trigger
      ...
      if (not results.pose_landmarks==None): #至少有一個身體
        ...
        if state>0:
          ...
          if  first!=state:
             ...
             if first==1:
               pyautogui.moveTo(random.randint(1350,1900),random.randint(50,360))
             elif first==2: 
               pyautogui.moveTo(random.randint(640,1280),random.randint(50,360))      
             elif first==3:
               pyautogui.moveTo(random.randint(50,500),random.randint(50,360))
             elif first==4:
               pyautogui.moveTo(random.randint(50,500),random.randint(360,720))  
             elif first==5:
               pyautogui.moveTo(random.randint(1350,1900),random.randint(360,720))
             elif first==6:
               pyautogui.moveTo(random.randint(50,500),random.randint(720,1030))
             elif first==7:
               pyautogui.moveTo(random.randint(1350,1900),random.randint(720,1030))  
             elif first==8:   
